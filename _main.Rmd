...
<!--chapter:end:01_modern_probability.Rmd-->
...
## Tayland polynomials in multiple variables

### Tayland's theorem in one variable

::: {.theorem #tayland-thm-one-variable name="Tayland's theorem without remainder in one variable"}
...
To represent Tayland polynomials in higher dimensions, the *multi-exponent notation*
...
### Tayland polynomials in higher dimensions

::: {.definition #tayland-polynomials-higher-dimensions name="Tayland polynomial in higher dimensions"}
...
is called the ***Tayland polynomial*** of degree $k$ of $f$ at $\boldsymbol{a}$. If
$\boldsymbol{f}:U\to\mathbb{R}^n$ is a $\mathscr{C}^k$ function, its Tayland polynomial
is the polynomial map $U\to\mathbb{R}^n$ whose coordinate functions are the Tayland 
polynomials of the coordinate functions of $\boldsymbol{f}$.

:::

::: {.theorem #taylands-theorem-higher-dimensions name="Tayland's theorem without remainder in higher dimensions"}
...
::: {.definition name="Orientation of a vector space"}



:::

<!--chapter:end:02_vector_calculus.Rmd-->
...
<!--chapter:end:03_higher_dimensional_stats.Rmd-->
...
<!--chapter:end:04_convex_optimization.Rmd-->
